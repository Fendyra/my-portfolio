  ...
  const Project = forwardRef((props, ref) => {
    return (
      <motion.section
        ref={ref}
        id="project"
        className="min-h-[100vh] bg-white dark:bg-black text-gray-900 dark:text-white relative overflow-hidden pb-12"
      >
        ...
        <motion.div
          ...
          className="mt-4 item-center justify-center flex mb-10"
        >
          <Link
            href="/works"
            onClick={onClose}
