      ...
      >
        ...
        <div className="max-w-screen-xl mx-auto px-2 sm:px-4 lg:px-6">
          <motion.div
            ...
            className="text-4xl md:text-5xl lg:text-6xl font-bold justify-left mb-16 px-2 sm:px-4 lg:px-6 text-gray-900 dark:text-white"
          >
            The Essentials:
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 text-justify">
                I transform ideas into clear, user-centered wireframes that
                focus on usability and structure. This stage lays the foundation
                for seamless UI/UX by aligning visual logic with user goals.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 text-justify">
                ...
                frontend code using modern frameworks. Every element is built
                with precision to ensure both performance and visual
                consistency.
              </p>
            </motion.div>
